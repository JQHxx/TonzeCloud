...
@implementation TJYFoodRecommendCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _weightLabel=  InsertLabel(self.contentView, CGRectMake(_menuNameLable.left,_menuNameLable.bottom, 180, 15), NSTextAlignmentLeft, @"", kFontSize(12), UIColorHex(0x959595), NO);
        _caloriesLable = InsertLabel(self.contentView, CGRectMake(kScreenWidth - 160,(58 - 15)/2, 150, 15), NSTextAlignmentRight, @"", kFontSize(15), UIColorHex(0x626262), NO);
