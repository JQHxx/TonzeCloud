...
@interface DOPIndexPath : NSObject@property (nonatomic, assign) NSInteger
 ...
 *  处理方法，不显示下拉
 */
typedef void (^DOPDropDownMenuBlock)();
@property (nonatomic, assign) NSInteger handleTag;
@property (nonatomic, copy) DOPDropDownMenuBlock dropDownMenuBlock;
